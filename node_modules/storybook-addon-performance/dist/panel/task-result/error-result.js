...
export default function ErrorResultView({ task, result }) {
    ...
    return (React.createElement(ExpandingResult, { taskId: task.taskId, name: task.name, result: resultNode, getExpanded: ({ isExpanded }) => isExpanded ? React.createElement(Expanded, { task: task, result: result }) : null }));
}
