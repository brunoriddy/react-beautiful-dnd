...
export function ExpandingResult({ taskId, name, result, getExpanded }) {
    ...
    return (React.createElement(Container, null,
        ...
        isExpanded ? (React.createElement(Expand.Section, null,
            React.createElement(Button, { secondary: true, small: true, disabled: !nextEventsInclude('START_ONE', state.nextEvents), onClick: () => send({ type: 'START_ONE', taskId }) },
                "Run task",
                ' ',
