...
export default React.memo(function TaskGroup({ group, result, pinned }) {
    return (React.createElement(Container, null,
        ...
        group.tasks.map((task) => {
            return (React.createElement(TaskResult, { key: task.taskId, task: task, result: result.map[task.taskId] || null, pinned: (pinned === null || pinned === void 0 ? void 0 : pinned.map[task.taskId]) || null }));
        })));
});
